      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 100 }]}>
        <BossProfile data={BOSS_DATA} />
          <Text style={styles.sectionTitle}>매장 기록</Text>
            <TouchableOpacity style={styles.menuItem} activeOpacity={0.7} onPress={() => router.push('/boss/BossInfo')}>
                ...
                <View style={modalStyles.inputGroup}>
                  ...
                  <View style={[modalStyles.passwordInputWrapper, currentPwError !== '' && modalStyles.inputError]}>
                    <TextInput 
                      ...
                      placeholder="현재 비밀번호를 입력해 주세요." placeholderTextColor="#AFAFAF" 
          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={modalStyles.overlay}>
            <View style={modalStyles.modalContainer}>
              ...
              <View style={modalStyles.withdrawWarningBox}>
                ...
                <Text style={modalStyles.withdrawWarningText}>탈퇴 시 모든 데이터가 <Text style={{color: '#FF383C', fontWeight: 'bold'}}>삭제</Text>됩니다.</Text>
              </View>
